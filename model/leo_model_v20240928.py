...
modulation_indices.append(0)
modulation_indices.append(1)
modulation_indices.append(2)
modulation_indices.append(3)
...
class SZZBPM(nn.Module):
    ...
    def forward(self, input: torch.Tensor) -> torch.Tensor:
        ...
        u0 = u0 * modulation1_bpm
        u1 = torch.fft.ifft2(torch.fft.fft2(u0) * self.DFR) * self.super_gaussian
        u0 = u1
        
        u0 = u0 * modulation2_bpm
        u1 = torch.fft.ifft2(torch.fft.fft2(u0) * self.DFR) * self.super_gaussian
        u0 = u1

        u0 = u0 * modulation3_bpm
        u1 = torch.fft.ifft2(torch.fft.fft2(u0) * self.DFR) * self.super_gaussian
        u0 = u1

        u0 = u0 * modulation4_bpm
        u1 = torch.fft.ifft2(torch.fft.fft2(u0) * self.DFR) * self.super_gaussian
        u0 = u1
